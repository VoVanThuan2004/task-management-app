...
const TaskCard = React.memo(({ task, index, onClick, onToggleComplete, onDeleteTask }) => {
        ...
        >
          ...
          <button
            ...
            className="absolute top-2 right-2 z-10 p-1.5 rounded-lg bg-red-100 backdrop-blur 
               ...
               hover:bg-red-150 hover:scale-110 shadow-sm border border-gray-200"
            title="Xóa task"
          >
            <Trash2
              size={13}
              className="text-gray-600 text-red-600 transition-colors"
            />
          </button>
